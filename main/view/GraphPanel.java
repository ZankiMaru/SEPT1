...
public class GraphPanel extends JPanel{
   ...
   JFreeChart chartRain;
	...
	private CategoryDataset createWindDataset() 
	{
	    ...
	    for (ForecastInterval inter: stationData.list2){
          if(inter.getAMPM() == 0)
             dataset.setValue( inter.wind, "Km/h", Integer.toString(inter.getDate()) + ":" + Integer.toString(inter.getHour()) + "AM");  
          else
             dataset.setValue( inter.wind, "Km/h", Integer.toString(inter.getDate()) + ":" + Integer.toString(inter.getHour()) + "PM");  
      }
		return dataset;         
	}
	private CategoryDataset createRainDataset() 
	{
      ...
      for (ForecastInterval inter: stationData.list2){
         if(inter.getAMPM() == 0)
            dataset.setValue( inter.rain, "mm", Integer.toString(inter.getDate()) + ":" + Integer.toString(inter.getHour()) + "AM");  
         else
            dataset.setValue( inter.rain, "mm", Integer.toString(inter.getDate()) + ":" + Integer.toString(inter.getHour()) + "PM");  
      }	
      return dataset;         
	}
